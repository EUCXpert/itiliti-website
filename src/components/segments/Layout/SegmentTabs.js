// src/components/segments/layout/SegmentTabs.js
...
const SegmentTabs = ({ tabs, activeTab, onChange }) => {
  ...
  if (!tabs || !Array.isArray(tabs)) {
    console.error('SegmentTabs: tabs prop is missing or not an array', tabs);
    return null;
  }
