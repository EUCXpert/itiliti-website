// src/components/segments/layout/SegmentOverview.js
import React, { useState, useEffect, useRef } from 'react';
import { Shield, ChevronRight, ChevronLeft, ArrowRight } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';

const SegmentOverview = ({ title, challenges, keyFeatures, metrics }) => {
      ...
      >
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            >
              {title} firms face unique technology challenges that generic solutions fail to address. 
          ...
          >
            <div className="flex flex-col md:flex-row items-start gap-6 relative z-10">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-blue-900">Our {title}-Specific Approach</h3>
