// src/components/segments/layout/SegmentCaseStudy.js
...
const SegmentCaseStudy = ({ title, caseStudy }) => {
...
>
How we helped {caseStudy.firmType} transform their operations with our {title} solutions
</motion.p>
</div>
</div>
...
>
Let's discuss how our solutions can transform your {title.toLowerCase()} operations and drive measurable improvements.
</motion.p>
