// src/components/segments/layout/SegmentHero.js
...
const SegmentHero = ({ 
  ...
  subtitle, 
  description, 
  backgroundImage = "/images/segment-hero-bg.jpg" // Default background
}) => {
  return (
      ...
      <div className="container relative mx-auto px-6 py-20 z-20">
        <div className="max-w-3xl">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-shadow-lg">
            {title}<br/><span className="text-blue-300">{subtitle}</span>
          </h1>
