    ...
    <div ref={solutionsRef}>
      ...
      >
        ...
        <div className="text-center relative mb-16">
          ...
          <motion.div 
            className="absolute -z-10 -top-10 left-1/4 w-40 h-40 bg-blue-50 rounded-full opacity-80 blur-3xl"
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
            transition={{ duration: 0.8 }}
          />
          <motion.div 
            className="absolute -z-10 -bottom-20 right-1/4 w-32 h-32 bg-indigo-50 rounded-full opacity-70 blur-2xl"
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
          ...
          <motion.div
            ...
            className="inline-flex items-center justify-center mb-4 bg-indigo-100 text-indigo-700 px-5 py-2 rounded-full text-sm font-semibold tracking-wide"
          >
            SOLUTIONS
          </motion.div>
          ...
          <h2 className="relative inline-block">
            ...
            >
              <span className="text-4xl md:text-5xl font-bold text-gray-900">Our </span>
              <span className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-700 to-blue-500">
                {firstHalf}
              </span>
            </motion.div>
            
            <motion.div
              className="inline-block md:block lg:inline-block relative mt-2 lg:mt-0 lg:ml-3"
              initial={{ y: 50, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
              transition={{ duration: 0.7, delay: 0.2 }}
            >
              <span className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-cyan-500">
                {secondHalf}
              </span>
            </motion.div>
            ...
            {/* Animated underline */}
            <motion.div 
              className="absolute -bottom-3 left-0 h-3 bg-gradient-to-r from-indigo-200 to-blue-200 opacity-50 rounded-full"
              initial={{ width: 0 }}
              animate={{ width: '100%' }}
